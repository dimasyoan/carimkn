                    ...
                    <form role="form">
                      <div class="box-body">
                        ...
                        {!! Form::select('waktubuka', array(
                              ...
                              'siang' => 'Siang',
                              'sore' => 'Sore',
                              'malam' => 'Malam'), null, ['class' => 'form-control', 'placeholder' => 'Pilih Waktu']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        {!! Form::select('kategori', array(
                              ...
                              'bakso' => 'Bakso',
                              'mie' => 'Mie',
                              'penyetan' => 'Penyetan'), null, ['class' => 'form-control', 'placeholder' => 'Pilih Kategori']) !!}
                        </div>
                        <div class="form-group">
